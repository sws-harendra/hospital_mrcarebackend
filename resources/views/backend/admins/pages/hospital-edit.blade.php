...
@push('title')
    <title>Edit Hospital | {{ env('APP_NAME') }}</title>
@endpush
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Edit Hospital: {{ $hospital->name }}</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admins.hospitals.update', $hospital->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="whatsapp_number" id="whatsapp_number" 
                                                   ...
                                                   value="{{ old('whatsapp_number', $hospital->whatsapp_number) }}" 
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="hospital_type" id="hospital_type" class="form-control @error('hospital_type') is-invalid @enderror">
                                                ...
                                                <option value="Government" {{ old('hospital_type', $hospital->hospital_type) == 'Government' ? 'selected' : '' }}>Government</option>
                                                <option value="Private" {{ old('hospital_type', $hospital->hospital_type) == 'Private' ? 'selected' : '' }}>Private</option>
                                                <option value="Trust" {{ old('hospital_type', $hospital->hospital_type) == 'Trust' ? 'selected' : '' }}>Trust</option>
                                                <option value="Charity" {{ old('hospital_type', $hospital->hospital_type) == 'Charity' ? 'selected' : '' }}>Charity</option>
                                                <option value="Corporate" {{ old('hospital_type', $hospital->hospital_type) == 'Corporate' ? 'selected' : '' }}>Corporate</option>
                                            </select>
                                            @error('hospital_type')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="ownership_type" id="ownership_type" class="form-control @error('ownership_type') is-invalid @enderror">
                                                ...
                                                <option value="Sole Proprietorship" {{ old('ownership_type', $hospital->ownership_type) == 'Sole Proprietorship' ? 'selected' : '' }}>Sole Proprietorship</option>
                                                <option value="Partnership" {{ old('ownership_type', $hospital->ownership_type) == 'Partnership' ? 'selected' : '' }}>Partnership</option>
                                                <option value="Private Limited" {{ old('ownership_type', $hospital->ownership_type) == 'Private Limited' ? 'selected' : '' }}>Private Limited</option>
                                                <option value="Public Limited" {{ old('ownership_type', $hospital->ownership_type) == 'Public Limited' ? 'selected' : '' }}>Public Limited</option>
                                                <option value="Government" {{ old('ownership_type', $hospital->ownership_type) == 'Government' ? 'selected' : '' }}>Government</option>
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="hospital_registration_number" id="hospital_registration_number" 
                                                   ...
                                                   value="{{ old('hospital_registration_number', $hospital->hospital_registration_number) }}" 
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="established_date" id="established_date" 
                                                   ...
                                                   value="{{ old('established_date', $hospital->established_date ? $hospital->established_date->format('Y-m-d') : '') }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="accreditations" id="accreditations" 
                                                   ...
                                                   value="{{ old('accreditations', $hospital->accreditations) }}" 
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="number_of_beds" id="number_of_beds" 
                                                   ...
                                                   value="{{ old('number_of_beds', $hospital->number_of_beds) }}" 
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="number_of_doctors" id="number_of_doctors" 
                                                   ...
                                                   value="{{ old('number_of_doctors', $hospital->number_of_doctors) }}" 
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="number_of_nurses" id="number_of_nurses" 
                                                   ...
                                                   value="{{ old('number_of_nurses', $hospital->number_of_nurses) }}" 
                                                   placeholder="e.g., 100" min="0">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="number_of_departments" id="number_of_departments" 
                                                   ...
                                                   value="{{ old('number_of_departments', $hospital->number_of_departments) }}" 
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="address" id="address" 
                                                      ...
                                                      rows="3" 
                                                      placeholder="Enter full address">{{ old('address', $hospital->address) }}</textarea>
                                            @error('address')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <div>
                                                        <img src="{{ asset($hospital->logo) }}" 
                                                             alt="{{ $hospital->name }}" 
                                                             class="current-logo rounded-circle" style="max-width: 200px">
                                                    </div>
                                                </div>
                                            @endif
                                            ...
                                            @error('logo')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            <small class="form-text text-muted">Leave empty to keep current logo. Max file size: 2MB</small>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" id="description" 
                                                      ...
                                                      rows="4" 
                                                      placeholder="Write about the hospital's facilities, specialties, etc.">{{ old('description', $hospital->description) }}</textarea>
                                            @error('description')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="url" name="facebook" id="facebook" 
                                                   ...
                                                   value="{{ old('facebook', $hospital->facebook) }}" 
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="url" name="twitter" id="twitter" 
                                                   ...
                                                   value="{{ old('twitter', $hospital->twitter) }}" 
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="url" name="linkedin" id="linkedin" 
                                                   ...
                                                   value="{{ old('linkedin', $hospital->linkedin) }}" 
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="url" name="instagram" id="instagram" 
                                                   ...
                                                   value="{{ old('instagram', $hospital->instagram) }}" 
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="url" name="youtube" id="youtube" 
                                                   ...
                                                   value="{{ old('youtube', $hospital->youtube) }}" 
                                        ...
                                        <div class="form-group">
                                            <label class="custom-switch mt-2">
                                                ...
                                                <input type="checkbox" name="status" 
                                                       ...
                                                       value="1"
                                                       {{ old('status', $hospital->status) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-group">
                                            <label class="custom-switch mt-2">
                                                ...
                                                <input type="checkbox" name="is_popular" 
                                                       class="custom-switch-input" 
                                                       value="1"
                                                       {{ old('is_popular', $hospital->is_popular) ? 'checked' : '' }}>
                                                <span class="custom-switch-indicator"></span>
                                        ...
                                        <div class="form-group">
                                            <label class="custom-switch mt-2">
                                                ...
                                                <input type="checkbox" name="is_featured" 
                                                       class="custom-switch-input" 
                                                       value="1"
                                                       {{ old('is_featured', $hospital->is_featured) ? 'checked' : '' }}>
                                                <span class="custom-switch-indicator"></span>
                                        ...
                                        <div class="form-group">
                                            <label class="custom-switch mt-2">
                                                ...
                                                <input type="checkbox" name="is_verified" 
                                                       class="custom-switch-input" 
                                                       value="1"
                                                       {{ old('is_verified', $hospital->is_verified) ? 'checked' : '' }}>
                                                <span class="custom-switch-indicator"></span>
